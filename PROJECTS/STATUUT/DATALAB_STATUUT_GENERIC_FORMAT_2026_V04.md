...
- [1. Doel, positie en reikwijdte](#sec-1-doel)
	...
	- [1.4 Werking van het statuut in de praktijk](#sec-1-4-praktijk)
...
- [Praktische handreiking: statuut stap voor stap hanteren](#sec-praktische-handreiking)
- [Begrippenlijst](#sec-begrippenlijst)
...
<a id="sec-1-4-praktijk"></a>

### 1.4 Werking van het statuut in de praktijk

De missie en positionering van het DataLab krijgen pas bestuurlijke en operationele betekenis wanneer zij ook consequent worden vertaald naar een herkenbare werkwijze. Daarom is dit statuut niet alleen bedoeld als normatief kader, maar ook als hanteerbaar werkdocument voor intake, triage, fasering, documentatie, escalatie en overdracht. De [praktische handreiking: statuut stap voor stap hanteren](#sec-praktische-handreiking) maakt die vertaling expliciet: zij ordent de route van eerste vraagverheldering tot afsluiting van een traject, zodat voor alle betrokkenen zichtbaar blijft welke stappen, afwegingen en beheersmaatregelen minimaal nodig zijn ([Hogeschool Rotterdam, 2026b](#ref-6)).

Voor onderzoekers, docenten, projectleiders, ondersteunende diensten en externe partners verduidelijkt deze werkwijze dat het DataLab geen ad-hoc voorziening is, maar een methodologisch en bestuurlijk ingebedde schakel. De handreiking ondersteunt daarmee de centrale lijn van dit statuut: mensgericht werken met data en AI, proportioneel omgaan met risico's, tijdig escaleren waar formele toetsing nodig is en hybride infrastructuur alleen inzetten binnen expliciete rollen, afspraken en verantwoordingslijnen. Zo blijft de missie uit paragraaf 1.1 direct verbonden met de governance-, infrastructuur- en gebruiksafspraken in de rest van het document.

---

<a id="sec-2-kernprincipes"></a>

## 2. Kernprincipes en bestuurlijke uitgangspunten

<a id="sec-2-1-human-centered"></a>
...
In zorgcontexten is dit ook inhoudelijk consistent met de gedachte dat AI vooral waarde toevoegt wanneer het professioneel oordeel, klinische context en menselijke verantwoordelijkheid versterkt in plaats van vervangt ([Topol, 2019](#ref-22)).
...
<a id="sec-3-governance"></a>

## 3. Governance, rollen en verantwoordelijkheden

<a id="sec-3-1-bestuurlijke-inrichting"></a>
...
Een dergelijke taakverdeling past bij datagovernance-benaderingen waarin rollen, controles en lifecycle-besluiten expliciet worden gemaakt in plaats van impliciet in tooling of projectgewoonte te verdwijnen.

<a id="sec-3-2-operationele-rollen"></a>
...
<a id="sec-4-werkwijze"></a>

## 4. Werkwijze per onderzoeksfase

<a id="sec-4-1-intake"></a>
...
<a id="sec-5-infrastructuur"></a>

## 5. Infrastructuur en DS-stack

<a id="sec-5-1-workspace"></a>
...
Het expliciet scheiden van deze lagen ondersteunt bovendien systematische modelevaluatie en reproduceerbaarheid, iets wat in ACM-literatuur over grote taalmodellen als randvoorwaarde voor betrouwbare inzet wordt benadrukt ([Chang et al., 2024](#ref-15)).

<a id="sec-5-3-keuze-omgeving"></a>
...
<a id="sec-6-governance-data-ai"></a>

## 6. Data-, privacy-, security- en AI-governance

<a id="sec-6-1-dataclassificatie"></a>
...
<a id="sec-6-2-privacy-security"></a>

### 6.2 Privacy, informatiebeveiliging en auditability

Het DataLab sluit aan op de privacy- en informatiebeveiligingsvolwassenheid die Hogeschool Rotterdam nastreeft. Dat betekent dat maatregelen niet impliciet of incidenteel mogen zijn, maar gedocumenteerd, formeel ingebed, aantoonbaar getest en periodiek geevalueerd moeten worden. Voor onderzoeksdata moet bovendien de juridische status van ruwe data, hergebruiksrechten en de route voor zorgvuldige deling van gezondheidsdata expliciet worden gedocumenteerd, zodat juridische en ethische randvoorwaarden niet pas achteraf zichtbaar worden ([Hogeschool Rotterdam, 2026b](#ref-6); [SURF Security Expertise Centrum, z.d.](#ref-8); [SURF, z.d.](#ref-13); [Data voor gezondheid, 2021](#ref-11); [Hartwig Medical Foundation, z.d.](#ref-12)).

Naast privacy en formele informatiebeveiliging hanteert het DataLab voor software, pipelines, API-koppelingen en AI-toepassingen het uitgangspunt van security by design en secure development. Daarbij worden, afhankelijk van aard, schaal en risicoklasse van het traject, vendor-neutrale applicatiebeveiligingskaders zoals OWASP betrokken en, bij generatieve AI of agentische toepassingen, in het bijzonder ook de relevante risico's uit de OWASP Top 10 for LLMs and Gen AI Apps, waaronder prompt injection, gevoelige-informatieblootstelling, supply-chain-kwetsbaarheden, data- en model poisoning, onjuiste outputafhandeling, overmatige autonomie en onbegrensde consumptie. Deze kaders dienen als praktische concretisering van ontwerp-, test-, hardening-, logging- en beheersmaatregelen binnen de gekozen omgeving ([OWASP Foundation, 2026](#ref-26); [OWASP Gen AI Security Project, 2025](#ref-27)).

Voor toegangsbeveiliging geldt bovendien dat MFA niet alleen aanwezig moet zijn, maar voor beheeraccounts, externe toegang, gevoelige onderzoeksomgevingen en andere verhoogde risicosituaties bij voorkeur phishing-resistant wordt ingericht. Waar technisch en organisatorisch haalbaar, verdient FIDO2-gebaseerde authenticatie, zoals passkeys of hardware security keys, de voorkeur boven zwakkere factoren zoals sms- of e-mailcodes. Ook de registratie, wijziging, vervanging en herstelprocedure van authenticatiefactoren moeten expliciet worden beheerst, gelogd en zo ingericht zijn dat zij geen informele bypass van de toegangsbeveiliging introduceren ([OWASP Cheat Sheet Series Team, 2026](#ref-28); [FIDO Alliance, 2026](#ref-29)).
...
- passende encryptie en ten minste MFA; voor verhoogde rechten en gevoelige omgevingen bij voorkeur phishing-resistant via FIDO2, passkeys of hardware security keys;
- veilige registratie, wijziging, vervanging en herstelprocedures voor authenticatiefactoren;
- DPIA-route of aanvullende privacy/security-afstemming indien nodig;
- expliciete export- en deelregels bij gevoelige data.

<a id="sec-6-3-ai-geletterdheid"></a>
...
<a id="sec-7-nis2-ai-act"></a>

## 7. Bestuurlijke verantwoordelijkheid: Nis2 & AI-ACT

<a id="sec-7-1-bestuursopgave"></a>
...
<a id="sec-8-samenwerking"></a>

## 8. Samenwerking, gedrag en gebruiksregels

<a id="sec-8-1-verwachtingen"></a>
...
Voor gevoelige onderzoeks- en zorgdata betekent dit ook dat delen, hergebruik en publicatie alleen plaatsvinden binnen expliciete afspraken over doel, context en beschermingsmaatregelen ([Data voor gezondheid, 2021](#ref-11); [Hartwig Medical Foundation, z.d.](#ref-12)).

<a id="sec-8-3-niet-toegestaan"></a>
...
<a id="sec-9-toegang"></a>

## 9. Toegang, gebruik en afsluiting

<a id="sec-9-1-procedure"></a>
...
4. technische inrichting van accounts, rechten, authenticatie en projectstructuren;
5. start van het traject met afgesproken evaluatiemomenten.

Toegang wordt altijd tijd-, doel- en rolgebonden ingericht.

Waar verhoogde rechten, externe toegang of gevoelige data aan de orde zijn, wordt MFA verplicht ingericht en waar mogelijk phishing-resistant via FIDO2 toegepast, met afzonderlijke aandacht voor veilige factorregistratie, vervanging en herstel ([OWASP Cheat Sheet Series Team, 2026](#ref-28); [FIDO Alliance, 2026](#ref-29)).

Deze route volgt de logica van gecontroleerde datalab-toegang waarin vraag, omvang, rollen en rechten in samenhang worden beoordeeld in plaats van pas tijdens uitvoering te worden hersteld ([Tilburg University, z.d.](#ref-14); [Autoriteit Persoonsgegevens, z.d.-a](#ref-9)).

<a id="sec-9-2-review"></a>
...
Voor onderzoeksdata impliceert dit ook dat onderscheid wordt gemaakt tussen eigendom van ruwe data, afgeleide datasets, code, modellen en documentatie, inclusief eventuele licentie- of gebruiksbeperkingen die hergebruik beperken ([SURF, z.d.](#ref-13)).
...
Juist bij generatieve en klinische toepassingen vraagt verantwoord publiceren extra aandacht voor contextverlies, privacyverlies en semantische vervorming van afgeleide output ([van Velzen et al., 2025](#ref-19); [Hartwig Medical Foundation, z.d.](#ref-12)).

<a id="sec-10-3-documentatie"></a>
...
<a id="sec-11-github"></a>

## 11. Projectmanagement via GitHub Enterprise SaaS

<a id="sec-11-1-waarom-github"></a>
...
<a id="sec-12-2-wijzigingsprocedure"></a>
...
<a id="ref-2"></a>
[2]  Europese Commissie, Directoraat-Generaal Onderwijs, Jeugd, Sport en Cultuur. (2026). *Guidelines on the ethical use of artificial intelligence and data in teaching and learning for educators* (2e ed.).<br>
<https://op.europa.eu/en/publication-detail/-/publication/f692aa0b-17a7-11f1-8870-01aa75ed71a1>

<a id="ref-3"></a>
[3]  Europees Parlement en de Raad. (2022). *Richtlijn (EU) 2022/2555 betreffende maatregelen voor een hoog gezamenlijk niveau van cyberbeveiliging in de Unie (NIS2-richtlijn).*<br>
<https://eur-lex.europa.eu/legal-content/NL/TXT/HTML/?uri=CELEX:32022L2555>

<a id="ref-4"></a>
[4]  Hogeschool Rotterdam. (2023). *Talent voor Transitie: Strategische agenda 2023-2028.*<br>
...
<a id="ref-5"></a>
[5]  Hogeschool Rotterdam. (2026a). *AI Scenario Guide – Business Case AI in het Onderwijs: Hybride AI Scenario.*<br>
<https://docent.cmi.hro.nl/willi/HYBRIDE_AI_SCENARIO/>

<a id="ref-6"></a>
[6]  Hogeschool Rotterdam. (2026b). *DataLab Healthcare.*<br>
<https://hr-datalab-healthcare.github.io/>

<a id="ref-7"></a>
[7]  Nationaal Cyber Security Centrum. (2026). *Over de Cyberbeveiligingswet (NIS2).*<br>
...
<a id="ref-8"></a>
[8]  SURF Security Expertise Centrum. (z.d.). *SURFaudit Toetsingskader informatiebeveiliging.*<br>
<https://sec.surf.nl/surfaudit-toetsingskader-informatiebeveiliging/>

<a id="ref-9"></a>
[9]  Autoriteit Persoonsgegevens. (z.d.-a). *De AVG in het kort.*<br>
<https://www.autoriteitpersoonsgegevens.nl/themas/basis-avg/avg-algemeen/de-avg-in-het-kort>

<a id="ref-10"></a>
[10] Autoriteit Persoonsgegevens. (z.d.-b). *Gezondheidsgegevens verwerken.*<br>
...
<a id="ref-11"></a>
[11] Data voor gezondheid. (2021). *ECP | Handleiding - Aanpak begeleidingsethiek voor AI in de zorg.*<br>
...
<a id="ref-12"></a>
[12] Hartwig Medical Foundation. (z.d.). *Oog voor de ethische aspecten van het delen van data.*<br>
<https://www.hartwigmedicalfoundation.nl/oog-voor-de-ethische-aspecten-van-het-delen-van-data/>

<a id="ref-13"></a>
[13] SURF. (z.d.). *De juridische status van ruwe data: een wegwijzer voor de onderzoekspraktijk.*<br>
<https://www.surf.nl/rapport-de-juridische-status-van-ruwe-data-een-wegwijzer-voor-de-onderzoekspraktijk>

<a id="ref-14"></a>
[14] Tilburg University. (z.d.). *Data Lab.*<br>
<https://www.tilburguniversity.edu/nl/campus/universiteitsbibliotheek/informatie-zoeken/financiele-bedrijfsgegevens/datalab>

<a id="ref-15"></a>
[15] Chang, Y., Wang, X., Wang, J., et al. (2024). *A survey on evaluation of large language models.* ACM Transactions on Intelligent Systems and Technology, 15(3), 1-45.<br>
<https://doi.org/10.1145/3641289>

<a id="ref-16"></a>
[16] Dhar, S., Guo, J., Liu, J., Tripathi, S., Kurup, U., & Shah, M. (2021). *A survey of on-device machine learning: An algorithms and learning theory perspective.* ACM Transactions on Internet of Things, 2(3), Article 15.<br>
<https://doi.org/10.1145/3450494>

<a id="ref-17"></a>
[17] He, Z., Zhang, T., & Lee, R. B. (2020). *Attacking and protecting data privacy in edge-cloud collaborative inference systems.* IEEE Internet of Things Journal, 8(12), 9706-9716.<br>
<https://doi.org/10.1109/JIOT.2020.3022358>

<a id="ref-18"></a>
[18] LeCun, Y., Bengio, Y., & Hinton, G. (2015). *Deep learning.* Nature, 521(7553), 436-444.<br>
<https://doi.org/10.1038/nature14539>

<a id="ref-19"></a>
[19] van Velzen, M., van der Willigen, R. F., de Beer, V. J., et al. (2025). *Privacy-, linguistic-, and information-preserving synthesis of clinical documentation through generative agents.* Frontiers in Artificial Intelligence, 8, 1644084.<br>
<https://doi.org/10.3389/frai.2025.1644084>

<a id="ref-20"></a>
[20] Miranda, M. L. (2026). *Higher education must bridge the AI gap.* Science, 392(6793), 5.<br>
<https://doi.org/10.1126/science.aeh5777>

<a id="ref-21"></a>
[21] Huang, L., Yu, W., Ma, W., et al. (2025). *A survey on hallucination in large language models: Principles, taxonomy, challenges, and open questions.* ACM Transactions on Information Systems, 43(2), Article 38.<br>
<https://doi.org/10.1145/3703155>

<a id="ref-22"></a>
[22] Topol, E. J. (2019). *High-performance medicine: The convergence of human and artificial intelligence.* Nature Medicine, 25(1), 44-56.<br>
<https://doi.org/10.1038/s41591-018-0300-7>

<a id="ref-23"></a>
[23] HR-DataLab-Healthcare. (z.d.-a). *RESEARCH_SUPPORT* [GitHub repository].<br>
<https://github.com/HR-DataLab-Healthcare/RESEARCH_SUPPORT>

<a id="ref-24"></a>
[24] HR-DataLab-Healthcare. (z.d.-b). *SCRUM_BOARD* [GitHub repository].<br>
<https://github.com/HR-DataLab-Healthcare/SCRUM_BOARD>

<a id="ref-25"></a>
[25] HR-DataLab-Healthcare. (z.d.-c). *HR-DataLab-Healthcare* [GitHub organization].<br>
<https://github.com/HR-DataLab-Healthcare>

<a id="ref-26"></a>
[26] OWASP Foundation. (2026). *OWASP.*<br>
<https://owasp.org/>

<a id="ref-27"></a>
[27] OWASP Gen AI Security Project. (2025). *OWASP Top 10 for LLMs and Gen AI Apps.*<br>
<https://genai.owasp.org/llm-top-10/>

<a id="ref-28"></a>
[28] OWASP Cheat Sheet Series Team. (2026). *Multifactor Authentication Cheat Sheet.*<br>
<https://cheatsheetseries.owasp.org/cheatsheets/Multifactor_Authentication_Cheat_Sheet.html>

<a id="ref-29"></a>
[29] FIDO Alliance. (2026). *FIDO2 / Passkeys.*<br>
<https://fidoalliance.org/fido2/>

---

<a id="sec-praktische-handreiking"></a>
...
Voor losse weergave of export is dezelfde Mermaid-flow ook apart opgenomen in [DATALAB_STATUUT_PRAKTISCHE_HANDREIKING_FLOW.md](./DATALAB_STATUUT_PRAKTISCHE_HANDREIKING_FLOW.md).
...
<a id="sec-begrippenlijst"></a>

## Begrippenlijst

| Begrip | Werkdefinitie binnen dit statuut | Zie vooral |
|---|---|---|
| <a id="term-ai"></a>**AI** | Kunstmatige intelligentie; in dit statuut zowel analytische, voorspellende, generatieve als agentische toepassingen. | [2.1](#sec-2-1-human-centered), [6.3](#sec-6-3-ai-geletterdheid), [7.3](#sec-7-3-ai-act) |
| <a id="term-ai-act"></a>**AI Act** | Europees regelgevend kader voor risicogebaseerde inzet van AI-toepassingen. | [7.3](#sec-7-3-ai-act), [7.4](#sec-7-4-vertaling) |
| <a id="term-ai-geletterdheid"></a>**AI-geletterdheid** | Het vermogen om AI-toepassingen verantwoord te begrijpen, gebruiken, beoordelen en begrenzen. | [1.1](#sec-1-1-missie), [6.3](#sec-6-3-ai-geletterdheid), [7.3](#sec-7-3-ai-act) |
| <a id="term-api-koppeling"></a>**API-koppeling** | Technische verbinding waarmee systemen of diensten geautomatiseerd data of functies uitwisselen. | [6.2](#sec-6-2-privacy-security) |
| <a id="term-auditability"></a>**Auditability** | De mate waarin handelingen, keuzes en wijzigingen navolgbaar en controleerbaar zijn vastgelegd. | [6.2](#sec-6-2-privacy-security), [10.3](#sec-10-3-documentatie), [11.1](#sec-11-1-waarom-github) |
| <a id="term-avg"></a>**AVG** | Algemene verordening gegevensbescherming; juridisch kader voor verwerking van persoonsgegevens. | [1.3](#sec-1-3-afbakening), [6.1](#sec-6-1-dataclassificatie) |
| <a id="term-dataclassificatie"></a>**Dataclassificatie** | Indeling van data naar gevoeligheid, risico en vereiste beheersmaatregelen. | [6.1](#sec-6-1-dataclassificatie), [9.1](#sec-9-1-procedure) |
| <a id="term-dmp"></a>**DMP** | Data Management Plan; afspraken over omgang met data gedurende het project en daarna. | [1.2](#sec-1-2-reikwijdte), [4.3](#sec-4-3-output), [10.3](#sec-10-3-documentatie) |
| <a id="term-dpia"></a>**DPIA** | Data Protection Impact Assessment; beoordeling van privacyrisico's en passende maatregelen. | [1.3](#sec-1-3-afbakening), [6.2](#sec-6-2-privacy-security) |
| <a id="term-ds-stack"></a>**DS-stack** | Gelaagde indeling van infrastructuur, toegang, data, verwerking, analyse en overdracht binnen het DataLab. | [5.2](#sec-5-2-ds-stack) |
| <a id="term-etl-elt"></a>**ETL/ELT** | Standaardpatronen voor het extraheren, transformeren en laden van data binnen workflows. | [5.2](#sec-5-2-ds-stack) |
| <a id="term-fair"></a>**FAIR** | Uitgangspunt dat data en metadata vindbaar, toegankelijk, interoperabel en herbruikbaar moeten zijn waar dat verantwoord kan. | [3.2](#sec-3-2-operationele-rollen) |
| <a id="term-fg-route"></a>**FG-route** | Route naar de Functionaris Gegevensbescherming of aanpalende privacy/security-functies voor formele afstemming. | [3.2](#sec-3-2-operationele-rollen), [3.3](#sec-3-3-escalatie) |
| <a id="term-fido2"></a>**FIDO2** | Standaard voor phishing-resistant authenticatie, bijvoorbeeld via passkeys of hardware security keys. | [6.2](#sec-6-2-privacy-security), [9.1](#sec-9-1-procedure) |
| <a id="term-github-enterprise-saas"></a>**GitHub Enterprise SaaS** | Zakelijke cloudvariant van GitHub voor repositories, rechten, reviews en projectsturing. | [11.1](#sec-11-1-waarom-github), [11.4](#sec-11-4-voorbeeld) |
| <a id="term-hybride-infrastructuur"></a>**Hybride infrastructuur** | Inrichtingsmodel waarin lokale, federatieve en externe capaciteit gecombineerd wordt onder expliciete regie. | [2.2](#sec-2-2-hybride), [5.3](#sec-5-3-keuze-omgeving), [7.4](#sec-7-4-vertaling) |
| <a id="term-least-privilege"></a>**Least privilege** | Principe dat iedere gebruiker of component slechts de minimale benodigde rechten krijgt. | [6.2](#sec-6-2-privacy-security) |
| <a id="term-mfa"></a>**MFA** | Multifactor-authenticatie; toegang op basis van meer dan één onafhankelijke factor. | [6.2](#sec-6-2-privacy-security), [9.1](#sec-9-1-procedure) |
| <a id="term-nis2"></a>**NIS2** | Europese richtlijn voor cyberbeveiliging, zorgplicht en bestuurlijke verantwoording in digitale ketens. | [7.2](#sec-7-2-nis2), [7.4](#sec-7-4-vertaling) |
| <a id="term-owasp"></a>**OWASP** | Vendor-neutrale gemeenschap en set van praktijkkaders voor applicatie- en softwarebeveiliging. | [6.2](#sec-6-2-privacy-security) |
| <a id="term-passkeys"></a>**Passkeys** | FIDO2-gebaseerde inlogmethode zonder traditioneel wachtwoord, gericht op sterke en gebruiksvriendelijke authenticatie. | [6.2](#sec-6-2-privacy-security), [9.1](#sec-9-1-procedure) |
| <a id="term-poc"></a>**PoC** | Proof of Concept; afgebakende verkenning om haalbaarheid of waarde van een oplossing vroeg te toetsen. | [1.2](#sec-1-2-reikwijdte), [4.2](#sec-4-2-fasen), [9.2](#sec-9-2-review) |
| <a id="term-rdm-support"></a>**RDM-support** | Ondersteuning bij Research Data Management, zoals metadata, archivering, bewaartermijnen en publicatieafspraken. | [3.2](#sec-3-2-operationele-rollen) |
| <a id="term-security-by-design"></a>**Security by design** | Uitgangspunt dat beveiliging vanaf ontwerp en ontwikkeling integraal wordt meegenomen. | [6.2](#sec-6-2-privacy-security) |
| <a id="term-smp"></a>**SMP** | Software Management Plan; afspraken over softwarekeuzes, versies, beheer, licenties en overdracht. | [1.2](#sec-1-2-reikwijdte), [4.3](#sec-4-3-output), [10.3](#sec-10-3-documentatie) |
| <a id="term-surf-research-cloud"></a>**SURF Research Cloud** | SURF-dienst voor schaalbare en reproduceerbare onderzoeksomgevingen. | [5.3](#sec-5-3-keuze-omgeving) |
| <a id="term-surf-research-drive"></a>**SURF Research Drive** | SURF-dienst voor opslag, samenwerking en projectstructuur voor onderzoeksdata. | [5.3](#sec-5-3-keuze-omgeving) |
| <a id="term-surf-sram"></a>**SURF SRAM** | SURF-dienst voor federatief toegangsbeheer, rollen en groepsbeheer. | [5.3](#sec-5-3-keuze-omgeving) |
| <a id="term-tre"></a>**TRE** | Trusted Research Environment; beveiligde onderzoeksomgeving voor gevoelige data en strikte exportregels. | [1.2](#sec-1-2-reikwijdte), [5.3](#sec-5-3-keuze-omgeving) |
