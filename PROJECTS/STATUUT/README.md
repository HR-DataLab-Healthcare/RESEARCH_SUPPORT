...
<a id="ref-11"></a>
[11] DAMA NL. (2023). *Data Science Governance Framework.*<br>
<https://dama-nl.org/wp-content/uploads/2023/03/DAMA-NL-Data-Science-Governance-Framework-2023.2.pdf>

<a id="ref-12"></a>
[12] Data voor gezondheid. (2021). *ECP | Handleiding - Aanpak begeleidingsethiek voor AI in de zorg.*<br>
...
<a id="ref-13"></a>
[13] Hartwig Medical Foundation. (z.d.). *Oog voor de ethische aspecten van het delen van data.*<br>
<https://www.hartwigmedicalfoundation.nl/oog-voor-de-ethische-aspecten-van-het-delen-van-data/>

<a id="ref-14"></a>
[14] SURF. (z.d.). *De juridische status van ruwe data: een wegwijzer voor de onderzoekspraktijk.*<br>
<https://www.surf.nl/rapport-de-juridische-status-van-ruwe-data-een-wegwijzer-voor-de-onderzoekspraktijk>

<a id="ref-15"></a>
[15] Tilburg University. (z.d.). *Data Lab.*<br>
<https://www.tilburguniversity.edu/nl/campus/universiteitsbibliotheek/informatie-zoeken/financiele-bedrijfsgegevens/datalab>

<a id="ref-16"></a>
[16] Chang, Y., Wang, X., Wang, J., et al. (2024). *A survey on evaluation of large language models.* ACM Transactions on Intelligent Systems and Technology, 15(3), 1-45.<br>
<https://doi.org/10.1145/3641289>

<a id="ref-17"></a>
[17] Dhar, S., Guo, J., Liu, J., Tripathi, S., Kurup, U., & Shah, M. (2021). *A survey of on-device machine learning: An algorithms and learning theory perspective.* ACM Transactions on Internet of Things, 2(3), Article 15.<br>
<https://doi.org/10.1145/3450494>

<a id="ref-18"></a>
[18] He, Z., Zhang, T., & Lee, R. B. (2020). *Attacking and protecting data privacy in edge-cloud collaborative inference systems.* IEEE Internet of Things Journal, 8(12), 9706-9716.<br>
<https://doi.org/10.1109/JIOT.2020.3022358>

<a id="ref-19"></a>
[19] LeCun, Y., Bengio, Y., & Hinton, G. (2015). *Deep learning.* Nature, 521(7553), 436-444.<br>
<https://doi.org/10.1038/nature14539>

<a id="ref-20"></a>
[20] van Velzen, M., van der Willigen, R. F., de Beer, V. J., et al. (2025). *Privacy-, linguistic-, and information-preserving synthesis of clinical documentation through generative agents.* Frontiers in Artificial Intelligence, 8, 1644084.<br>
<https://doi.org/10.3389/frai.2025.1644084>

<a id="ref-21"></a>
[21] Miranda, M. L. (2026). *Higher education must bridge the AI gap.* Science, 392(6793), 5.<br>
<https://doi.org/10.1126/science.aeh5777>

<a id="ref-22"></a>
[22] Huang, L., Yu, W., Ma, W., et al. (2025). *A survey on hallucination in large language models: Principles, taxonomy, challenges, and open questions.* ACM Transactions on Information Systems, 43(2), Article 38.<br>
<https://doi.org/10.1145/3703155>

<a id="ref-23"></a>
[23] Topol, E. J. (2019). *High-performance medicine: The convergence of human and artificial intelligence.* Nature Medicine, 25(1), 44-56.<br>
<https://doi.org/10.1038/s41591-018-0300-7>

<a id="ref-24"></a>
[24] HR-DataLab-Healthcare. (z.d.-a). *RESEARCH_SUPPORT* [GitHub repository].<br>
<https://github.com/HR-DataLab-Healthcare/RESEARCH_SUPPORT>

<a id="ref-25"></a>
[25] HR-DataLab-Healthcare. (z.d.-b). *SCRUM_BOARD* [GitHub repository].<br>
<https://github.com/HR-DataLab-Healthcare/SCRUM_BOARD>

<a id="ref-26"></a>
[26] HR-DataLab-Healthcare. (z.d.-c). *HR-DataLab-Healthcare* [GitHub organization].<br>
...
flowchart TD
	...
	I --> K{"Is extra bestuurlijke,<br/>privacy- of security-escalatie nodig?"}
	J --> K
	K -- Ja --> L["6A. Escaleer naar bevoegde rollen<br/>Gebruik hoofdstuk 3.3 en 7"]
	K -- Nee --> M["6B. Kies passende omgeving<br/>Lokaal, SURF, cloud of TRE via hoofdstuk 5.3"]
	L --> M
	M --> N["7. Leg rollen, toegang, tooling,<br/>documentatie en werkafspraken vast<br/>Gebruik hoofdstuk 3, 8, 9 en 10"]
	N --> O["8. Voer traject gefaseerd uit<br/>Met logging, review en reproduceerbaarheid"]
	O --> P{"Verandert scope,<br/>data of AI-functionaliteit?"}
	P -- Ja --> Q["9A. Herbeoordeel project<br/>Gebruik hoofdstuk 9.2 en hoofdstuk 7"]
	P -- Nee --> R["9B. Rond project af"]
	Q --> M
	R --> S["10. Regel overdracht, archivering,<br/>publicatie en intrekken toegang<br/>Gebruik hoofdstuk 9.3, 10 en 12"]
	S --> T(["Einde: traject bestuurlijk en methodologisch afgerond"])
```
